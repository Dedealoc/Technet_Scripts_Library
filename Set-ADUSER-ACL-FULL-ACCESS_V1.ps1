...

{
  ...
  function Set-ADUSER-ACL-FULL-ACCESS {
...
Write-Host 'ACL Permissions Summary:User home directory will be Restored ACL FULL ACCESS' -ForegroundColor White
...
#(6)_.Run ACL Change
Set-ADUSER-ACL-FULL-ACCESS -UserName $userName 